...
.image-gallery {
  ...
  gap: 20px;                             /* יוצר רווח נקי ומודרני בין התמונות */
...
.image-gallery img {
  width: 100%;                           /* התמונה מתרחבת לכל רוחב המשבצת שלה */
  height: 250px;                         /* מגדיר גובה אחיד לכל התמונות כדי שיהיו שוות */
  object-fit: cover;                     /* חותך את התמונה בצורה חכמה כדי שלא תתעוות או תימתח */
  border-radius: 8px;                    /* בונוס: פינות מעוגלות ועדינות למראה מקצועי */
}
